...
$photo_upload_path = "C:/MATLAB/MATLAB/R2015a/bin/test/upload/";
...
if(copy($_FILES['uploadedfile']['tmp_name'], $photo_upload_path)) {
	...
	$command = "\"C:\\MATLAB\\MATLAB\\R2015a\\bin\\matlab.exe\"-nodisplay -nosplash -nodesktop -r \"cream4('$photo_upload_path','$processed_photo_output_path');exit\"";
	exec($command);
